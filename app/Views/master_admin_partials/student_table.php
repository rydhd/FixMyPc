    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a id="modalEditButton" href="/master/students/edit" class="btn btn-info">Edit</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        studentDetailsModal.addEventListener('show.bs.modal', function (event) {
            ...
            editButton.href = baseUrl + 'master/students/edit/' + studentId;
            deleteForm.action = baseUrl + 'master/students/delete/' + studentId;
        });
    });
</script>